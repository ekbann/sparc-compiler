...
case m_extern: printf("extern, "); break;
case m_register: printf("register, "); break;
default: break;
}
...
case e_fn: return("e_fn");
case e_const: return("e_const");
...
if (r) type_error(p->linenum);			/* still more CALL parms */
return;
}
